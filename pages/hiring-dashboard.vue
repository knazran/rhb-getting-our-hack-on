  ...
  <main class="px-8 pb-16 mt-4">
    ...
    >
      ...
      >
        ...
        <div
          class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle w-1/2"
        >
          <div class="bg-white px-6 py-4">
            <h4 class="text-base text-gray-400 uppercase">Boost a Challenge</h4>
            <h3 class="text-xl font-semibold text-gray-900 uppercase">Go</h3>
            <!-- <h4 class="text-base font-bold uppercase text-rhb-blue-800">Boost a Challenge</h4>
            <h3 class="text-xl font-semibold text-gray-900 uppercase">Go</h3> -->
            <div class="mb-4">
              <div>
                <h4 class="mt-4 text-base text-gray-600">Targeted Group</h4>
                <h3 class="text-lg font-semibold text-gray-900">KL Golang User Group</h3>
              </div>
              ...
              <div class="mb-4">
                ...
                <h3 class="text-lg font-semibold text-gray-900">
                  ...
                  your coding skills and contact you. #GettingOurHackOn #Go #CodingChallenge #HackForHire
                </h3>
              </div>
            </div>
          </div>
          <div class="px-4 py-3 sm:px-6 sm:flex justify-between space-x-4">
            <div class="justify-between space-x-4 items-center">
              <button class="py-2 text-lg text-gray-500 align-top">Share to</button>
              <ShareNetwork
              class=""
              network="facebook"
            ...
            >
              <IconifyIcon :icon="icons.facebook" height="40" class="inline rounded-lg text-fb-blue" />
            </ShareNetwork>
            ...
            <ShareNetwork
              ...
              hashtags="rhb,job,career,go,coding"
            >
              <IconifyIcon :icon="icons.linkedin" height="40" class="inline rounded-lg text-linkedin-blue" />
            </ShareNetwork>
            ...
            <ShareNetwork
              ...
              hashtags="rhb,job,career,go,coding"
            >
              <IconifyIcon :icon="icons.twitter" height="40" class="inline rounded-lg text-blue-400" />
            </ShareNetwork>
            </div>
            
            <button @click="hideModal" class="px-8 py-2 text-lg text-gray-500">Dismiss</button>
          </div>
        </div>
      </div>
    </div>
      ...
      <dl class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
        ...
        >
          ...
          <dd class="flex items-baseline ml-24">
            ...
            <p class="flex items-baseline ml-2 text-lg font-semibold text-green-600">
              <ArrowUpIcon class="self-center flex-shrink-0 w-5 h-5 text-green-600"></ArrowUpIcon>
        ...
        >
          ...
          <dd class="flex items-baseline ml-24">
            ...
            <p class="flex items-baseline ml-2 text-lg font-semibold text-red-600">
              <!-- Heroicon name: solid/arrow-sm-up -->
              <ArrowDownIcon class="self-center flex-shrink-0 w-5 h-5 text-red-600"></ArrowDownIcon>
    ...
    <div class="grid grid-cols-2 gap-8 mb-8">
      ...
      >
        <!-- Header -->
        <h4 class="pl-4 text-base text-gray-400 uppercase">CHALLENGE SOLVED CATEGORISE BY SKILL</h4>
        <h3 class="pl-4 text-xl font-semibold text-gray-900 uppercase">Top Skill Set</h3>
        <div class="absolute right-0 p-2 inset-y-1">
          <!-- Heroicon name: solid/chevron-right -->
          <button @click="isChartLeftSettings = true">
            <DotsVerticalIcon class="w-10 h-10 text-gray-400 group-hover:text-gray-700"></DotsVerticalIcon>
          </button>
        </div>
      ...
      >
        <!-- Header -->
        <h4 class="pl-4 text-base text-gray-400 uppercase">CHALLENGE SOLVED Over Time</h4>
        <div class="flex pl-4">
          <h3 class="text-xl font-semibold text-gray-900 uppercase">Challenge Trend</h3>
          <span class="flex items-baseline ml-2 text-lg font-semibold text-green-500">
            <ArrowUpIcon class="self-center flex-shrink-0 w-4 h-4 font-light text-green-500"></ArrowUpIcon>
            <p class="py-1">3.8%</p>
          </span>
        </div>
              ...
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <tr v-for="candidate in candidateList" :key="candidate.email" class="relative">
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="flex items-center">
                        <div class="flex-shrink-0 w-10 h-10">
                          <img class="w-10 h-10 rounded-full" :src="candidate.image" alt />
                        </div>
                        <div class="ml-4">
                    ...
                    >
                      <p v-for="skill in candidate.skillset" :key="skill">{{ skill }}</p>
                    </td>
...
import twitterFilled from "@iconify/icons-ant-design/twitter-square-filled";
