<template>
  <div
    class="relative rounded-20 py-3 pr-4 pl-6 bg-tgray-700 h-full w-full"
    
    >
    <!-- style="box-shadow: 0px 16px 60px rgba(108, 206, 230, 0.2);" -->
    <!-- Header -->
    <span class="text-xl font-semibold text-white">Node.js:</span> <span class='font-semibold text-green-300 text-xl'>Proficient</span>
